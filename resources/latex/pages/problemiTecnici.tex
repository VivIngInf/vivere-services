\section { ProblemiTecnici }

\subsection{ Idea }

\par
{
    La piattaforma ProblemiTecnici deve permettere agli utenti di segnalare un problema tecnico ai manutentori delle applicazioni.
}
...
\par
{
    Sarebbe carino e più professionale, trasformarla in una piattaforma di ticketing vera e propria, magari integrando nel profilo utente tra le notifiche gli sviluppi.
