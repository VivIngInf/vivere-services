...
\par
{
    ...
    Gli eventi possono includere un ristoro, si dovrà specificare cosa ci sarà da mangiare e si dovranno prevedere allergeni ed intolleranze.

    Se si dovesse fare un sondaggio, allora l'utente potrà specificare le sue intolleranze.
}
