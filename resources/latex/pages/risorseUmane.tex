...
\subsubsection{La piattaforma}
    ...
    Inoltre, esclusivamente agli staffer ed agli amministratori, sarà richiesto inserire:
    \begin{itemize}
        \item Codice Fiscale
        \item Citta, Provincia, stato di nascita
    \end{itemize}
    ...
    Il sistema dovrà prevedere un \textbf{sisteme di notifiche}, arriveranno sia in piattaforma che tramite mail.

    Ogni notifica può avere dei \textbf{documenti associati in allegato}.

    Ogni ottobre la piattaforma chiederà agli utenti se le informazioni sul loro anno frequentato sono corrette, in modo tale da mantenere veritero il DB.
...
\subsubsection{Gli amministratori}
    ...
    Gli amministratori potranno \textbf{mandare notifiche} in broadcast.
