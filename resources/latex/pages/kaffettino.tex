...
\subsubsection{ Utenti }
    ...
    Gli utenti potranno pagare anche tramite la piattaforma, selezionando il prodotto che intendono acquistare e l'auletta (magari l'auletta selezionata automaticamente in base alla posizione).
...
\subsubsection{Amministratori}
    ...
    Gli amministratori, dall'app web, potranno \textbf{offrire degli item}, in modo tale che contino come item scalati dal magazzino ma non come soldi entrati dall'auletta.
