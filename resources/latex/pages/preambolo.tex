...
Non si potranno cancellare e verranno memorizzati direttamente in OS. Saranno di tipo append-only e non modificabili, al fine di garantire l’integrità storica delle operazioni.

Ogni \textbf{software} dovrà essere \textbf{adeguatamente documentato e commentato}, questo in modo tale da permettere a futuri developer di poter prendere in mano lo sviluppo senza sforzi.

Ogni \textbf{software} dovrà \textbf{reindirizzare, in caso di mancata autenticazione,} alla piattaforma Risorse Umane.

Bisogna prevedere un modo per fare \textbf{visualizzare i changelog al primo login utile} in una qualsiasi piattaforma.

Ogni piattaforma deve prevedere un link per una \textbf{pagina di suggerimenti su cosa poter migliorare o su idee che vengono} agli studenti.
